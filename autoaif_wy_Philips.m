function [Signal_AIF,cutoffs_AIF,position,Conct_AIF,Images,n_AIFslice,AIF,positionAIF] = autoaif_wy_Philips(path_DSC,N_Slices,N_meas)
...
%             if mean(temp(1:timepoints/10)) > 0.95*mean(temp(end-timepoints/10:end))
